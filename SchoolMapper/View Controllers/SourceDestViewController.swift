...
class SourceDestViewController: UIViewController, UITextFieldDelegate {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        let node001 = MyNode(name: "001") //must be numbers (001-010 are junctions)
        ...
        let node801 = MyNode(name: "801") // main entrance (room 801 dne, just a naming structure)
        ...
        //add IMC rooms
        myGraph.add([node001, node002, node003, node004, node005, node006, node007, node008, node009, node010, node011, node012, node013, node014, node015, node016, node017, node018, node019, node020, node021, node022, node023, node024, node025, node026, node027, node028, node029, node030, node031, node032, node033, node034, node035, node036, node037, node038, node039, node040, node041, node042, node043, node044, node045, node046, node047, node048, node049, node050, node051, node052, node053, node054, node055, node056, node057, node058, node801, node711, node713, node715, node717, node712, node714, node742, node710, node720, node374, node370, node368, node366, node362, node360, node333, node331, node332, node339, node340, node341, node344, node345, node348, node349, node320, node316, node312, node304, node554, node556, node660, node665, node663, node667, node669, node661, node676, node678, /*node680, node682, node690, */ node537, node548, node628, node626, node624, node605, node603, node621, node620, node625, node627, node616, node610, node609, node607, node198, node199, node197, node194, node195, node193, node190, node191, node160, node159, node158, node157, node156, node155, node154, node153, node152, node151, node120, node119, node118, node117, node116, node112, node111, node110, node109, node108, node107, node103, node101, node100, /*node121, node123, node128, node122, node124, */ node176, node183, node181, node182, node184, /* node141, node142, node140, node138, node139, node135, node133, node167, node166, node164, node162*/])
